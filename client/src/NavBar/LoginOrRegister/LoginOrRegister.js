        ...
        return(
            <>
                <ul className='navbar-nav'>
                    ...
                    <li className='nav-item'>
                        <a type='button' className='nav-link' onClick={() => setRegisterModal(!isRegisterModal)}>
                ...
                { isRegisterModal && <Modal render={ <RegisterModal isModal ={ () => setRegisterModal(!isRegisterModal) } /> } /> }
            </>
        )
}
